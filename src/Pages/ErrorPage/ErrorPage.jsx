      ...
      <div className='container flex items-center min-h-screen px-6 py-12 mx-auto'>
        <div className='flex flex-col items-center max-w-sm mx-auto text-center'>
          ...
          <div className='flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto'>
            ...
            <button onClick={() => navigate('/')} className=" text-white rounded-[5px] bg-gradient-to-br from-[#66BE80] to-[#139196]  font-medium hover:bg-gradient-to-br hover:from-[#139196] hover:to-[#139196] cursor-pointer px-5 py-2 flex justify-center items-center duration-1000 ease-in-out transition-all">Take me Home</button>
          </div>
        </div>
      </div>
    </section>
