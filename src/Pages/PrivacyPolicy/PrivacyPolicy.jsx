        ...
        <section className="py-12 bg-gray-100">
            <Container>
                <div>
                    ...
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold mb-2">1. Personal Information:</h2>
                        <p>
                    ...
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold mb-2">2. Collecting Personal Information:</h2>
                        <p>
                    ...
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold mb-2">3. Using and Disclosing Your Personal Information:</h2>
                        <p>
                    ...
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold mb-2">4. Contact by the Company:</h2>
                        <p>
                        ...
                        <p className='mt-3'>If, at any point, you decide that you no longer wish to receive marketing communications from us, you can easily opt out by clicking on the "unsubscribe" link that will be included in all such emails.  We respect your preferences and will promptly remove you from our marketing list.</p>
                    </div>

                    <div className="mb-6">
                        <h2 className="text-2xl font-bold mb-2">5. Individual's Right of Access:</h2>
                        <p>
                    ...
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold mb-2">6. The Company and Links to Other Websites:</h2>
                        <p>
