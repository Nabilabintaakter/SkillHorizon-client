            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-6">
                {submissionData.length > 0 ? (
                    submissionData.map((item, index) => (
                        <Slide triggerOnce direction="up" delay={index * 2} key={index}>
                            <div
                                className="p-6 border rounded-lg shadow-md bg-white hover:shadow-lg transition-shadow flex flex-col justify-between h-[180px] w-full min-w-[300px]"
                            >
                                <div>
