                    ...
                    <SwiperSlide>
                        <div className=' flex flex-col gap-8 md:flex-row justify-between items-center py-14'>
                            <div className='flex flex-col justify-center items-center md:items-start w-full md:w-1/2 text-white space-y-4'>
                                ...
                                <button className=' text-black rounded-[5px] bg-[#F0BF79] font-medium hover:text-[#39A2AD] cursor-pointer px-5 py-2 md:py-[14px] flex gap-2 items-center'>Get Started Today <RiRewindStartMiniFill className='text-2xl font-bold' /></button>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className=' flex flex-col gap-8 md:flex-row justify-between items-center py-14'>
                            <div className='flex flex-col justify-center items-center md:items-start w-full md:w-1/2 text-white space-y-4'>
                                ...
                                <button className=' text-black rounded-[5px] bg-[#F0BF79] font-medium hover:text-[#39A2AD]  cursor-pointer px-5 py-2 md:py-[14px] flex gap-2 items-center'>Explore Courses <RiRewindStartMiniFill className='text-2xl font-bold' /></button>
                            </div>
                            <div className=' w-full md:w-1/2  flex justify-center'><img className='relative z-10 object-cover w-[300px] h-[390px] rounded-3xl shadow-2xl' src={banner} alt="" />
                                <div className='absolute border-[2px] border-[#95D3A2] w-[300px] h-[390px] rounded-[28px] right-6  bottom-6 sm:right-40  md:right-1 lg:right-10 md:top-[85px] xl:right-32 xl:top-[87px]'></div>
                            </div>
                    ...
                    <SwiperSlide>
                        <div className=' flex flex-col gap-8 md:flex-row justify-between items-center py-14'>
                            <div className='flex flex-col justify-center items-center md:items-start w-full md:w-1/2 text-white space-y-4'>
                                ...
                                <button className=' text-black rounded-[5px] bg-[#F0BF79] font-medium hover:text-[#39A2AD]  cursor-pointer px-5 py-2 md:py-[14px] flex gap-2 items-center'>Start Learning Now <RiRewindStartMiniFill className='text-2xl font-bold' /></button>
                            </div>
                            <div className=' w-full md:w-1/2  flex justify-center'><img className='relative z-10 object-cover w-[300px] h-[390px] rounded-3xl shadow-2xl' src={banner} alt="" />
                                <div className='absolute border-[2px] border-[#95D3A2] w-[300px] h-[390px] rounded-[28px] right-6  bottom-6 sm:right-40  md:right-1 lg:right-10 md:top-[85px] xl:right-32 xl:top-[87px]'></div>
                            </div>
