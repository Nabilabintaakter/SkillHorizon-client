    ...
    return (
        <Container>
            <div className='flex flex-col md:flex-row'>
                ...
                {/* right side */}
                <div className="w-full md:w-1/2 mt-8 md:mt-2 md:pl-8 lg:px-20 flex flex-col justify-center items-center sm:justify-start sm:items-start mb-5 md:mb-0">
                    <h2 className="text-center md:text-left text-2xl md:text-3xl font-semibold mb-2 text-gray-800">Hello, Welcome Back!</h2>
                    ...
                    <form className='w-full' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <p className='mt-5'>Don't have an account? <Link className='text-[#30A18E]' to={'/signUp'}>Sign Up</Link></p>
                    </form>
                </div>
            </div>
        </Container>
