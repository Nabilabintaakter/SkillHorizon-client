            ...
            <Container>
                <div className='flex flex-col md:flex-row'>
                    <div className='w-full md:w-1/2 bg-gradient-to-r from-[#95D3A2] to-[#36A0AD] h-[260px] sm:h-[400px] md:h-[560px] flex flex-col items-center justify-center relative'>
                        ...
                        <p className='text-sm sm:text-base text-white dark:text-[#282834]/70 text-center'>Choose from over 50+ online courses</p>
                    </div>
                    {/* right side */}
                    <div className="w-full md:w-1/2 mt-8 md:mt-5 px-5 sm:px-10 md:pl-8 lg:px-20 flex flex-col justify-center items-center sm:justify-start sm:items-start mb-5 md:mb-0">
                        <h2 className="text-center md:text-left text-2xl md:text-3xl font-semibold mb-2 text-gray-800 dark:text-white">Welcome Back!</h2>
                        <p className="text-gray-500 dark:text-gray-300 mb-4 text-center md:text-left md:text-lg">Login with your data that you entered during your Registration.</p>
                        ...
                        <p className='mt-5 text-center dark:text-gray-200'>Don't have an account? <Link className='text-[#30A18E] dark:text-[#66BE80]' to={'/signUp'}>Sign Up</Link></p>
                    </div>
                </div>
            </Container>
        </div>
