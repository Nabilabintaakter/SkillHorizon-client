            ...
            <Container>
                <div className='flex flex-col md:flex-row'>
                    <div className='w-full md:w-1/2 bg-gradient-to-r from-[#95D3A2] to-[#36A0AD] h-[260px] sm:h-[400px] md:h-[870px] lg:h-[820px]  flex flex-col items-center justify-center md:justify-normal relative md:pt-20 lg:pt-10'>
                        ...
                        <h1 className='text-white dark:text-[#282834] text-center text-2xl sm:text-3xl lg:text-[40px] font-bold w-[90%] sm:w-[70%] md:w-[90%] lg:w-[70%] leading-none mt-2 sm:mt-0 mb-2 sm:mb-3'>Turn your ambition into a success history</h1>
                        <p className='text-sm sm:text-base text-white text-center dark:text-[#282834]/70 '>Choose from over 50+ online courses</p>
                    </div>
                    {/* right side */}
                    <div className="w-full md:w-1/2 mt-8 md:mt-5 px-5 sm:px-10 md:pl-8 lg:px-20 flex flex-col justify-center items-center sm:justify-start sm:items-start mb-5 md:mb-0">
                        <h2 className="text-center md:text-left text-2xl md:text-3xl font-semibold mb-2 text-gray-800 dark:text-white">Create your free account!</h2>
                        <p className="text-gray-500 dark:text-gray-300 mb-4 text-center md:text-left md:text-lg">See how the world's best user experiences are created.</p>
                        <form className='w-full' onSubmit={handleSubmit(onSubmit)}>
                            {/* Name Field */}
                            <div className="mb-3">
                                <label htmlFor="name" className="block text-base md:text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Full Name</label>
                                <input
                                    id="name"
                                    type="text"
                            ...
                            <div className='mb-4 w-full'>
                                <label htmlFor='image' className='block mb-2 dark:text-gray-200 text-sm'>
                                    Select Image:
                                </label>
                                <input
                                    type="file"
                            ...
                            {/* Email Field */}
                            <div className="mb-3">
                                <label htmlFor="email" className="block text-base md:text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Email Address</label>
                                <input
                                    id="email"
                                    type="email"
                            ...
                            <div className="mb-4 relative">
                                <label htmlFor="password" className="block text-base md:text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Password</label>
                                <input
                                    id="password"
                            ...
                            {/* Phone Number Field */}
                            <div className="mb-4">
                                <label htmlFor="phoneNumber" className="block text-base md:text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Phone Number</label>
                                <input
                                    id="phoneNumber"
                                    type="number"
                            ...
                            <button type='submit' className="text-white rounded-[5px] bg-gradient-to-r from-[#66BE80] to-[#139196] font-medium hover:bg-gradient-to-r hover:from-[#139196] hover:to-[#139196] cursor-pointer w-full py-2 flex justify-center items-center duration-1000 ease-in-out transition-all">
                                {loading ? (
                                    <p className="flex items-center dark:text-gray-200 gap-2">Please wait...<ImSpinner9 className='animate-spin m-auto text-sm' /></p>
                                ) : (
                                    'Sign Up'
                                )}
                            </button>
                            ...
                            {/* Divider */}
                            <div className="divider dark:text-gray-200">OR</div>
                        </form>
                        {/* Google Sign-In */}
                        ...
                        {/* Redirect to Login */}
                        <p className='mt-5 text-center dark:text-gray-200'>Already have an account? <Link className='text-[#30A18E] dark:text-[#66BE80]' to={'/login'}>Login</Link></p>
                    </div>
                </div>
            </Container>
        </div>
